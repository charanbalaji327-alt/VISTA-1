const CACHE="vista-local-v3-analyzer-fix";
const ASSETS=["./","./index.html","./style.css","./tracking.css","./upgrade.css","./local-tools.css","./app.js","./local-tools.js","./manifest.webmanifest"];
